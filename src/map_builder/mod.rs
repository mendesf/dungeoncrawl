...
use crate::map_builder::themes::ForestTheme;
...
impl MapBuilder {
    pub fn new(rng: &mut RandomNumberGenerator) -> Self {
        ...
        // let mut mb = EmptyArchitect {}.new(rng);
    ...
    fn apply_vertical_tunnel(&mut self, y1: i32, y2: i32, x: i32) {
        // self.fill_with_floor(y1, y2, |y: i32| Point::new(x, y));
        use std::cmp::{min, max};
    ...
    fn apply_horizontal_tunnel(&mut self, x1: i32, x2: i32, y: i32) {
        // self.fill_with_floor(x1, x2, |x: i32| Point::new(x, y));
        use std::cmp::{min, max};
